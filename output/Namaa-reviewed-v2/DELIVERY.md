# تسليم مراجعة نماء — النسخة الثانية
...
- `assets/hardware/barcode-labels.webp`
- `assets/hardware/desktop-2d-scanner.webp`
- `assets/hardware/haixun-scanner.webp`
- `assets/hardware/rugged-scanner.webp`
- `assets/hardware/scanner-stand.webp`
- `assets/hardware/thermal-paper.webp`
- `assets/hardware/wired-scanner.webp`
- `assets/hardware/wireless-scanner.webp`
- `assets/hardware/xprinter-n160ii.webp`
- `js/tutorials-data.js`
- `DELIVERY.md`
...
| --- | --- | --- |
| قارئ باركود سلكي مع حامل | 150 NIS | [صفحة المنتج](https://logix-mobile.com/product.php?slug=wired-handheld-barcode-scanner-with-stand) |
| قارئ HAIXUN سلكي مع قاعدة | 180 NIS | [صفحة المنتج](https://logix-mobile.com/product.php?slug=haixun) |
| قارئ باركود سلكي مقاوم للصدمات | 200 NIS | [صفحة المنتج](https://logix-mobile.com/product.php?slug=rugged-wired-barcode-scanner-with-stand) |
| قارئ باركود مكتبي ثنائي الأبعاد | 350 NIS | [صفحة المنتج](https://logix-mobile.com/product.php?slug=desktop-omnidirectional-2d-barcode-scanner) |
| قارئ باركود لاسلكي مع قاعدة شحن | 350 NIS | [صفحة المنتج](https://logix-mobile.com/product.php?slug=wireless-barcode-scanner-with-charging-data-cradle) |
| حامل قارئ الباركود | 30 NIS | [صفحة المنتج](https://logix-mobile.com/product.php?slug=barcode-scanner-stand-holder) |
| رول ورق حراري للفواتير | 5 NIS | [صفحة المنتج](https://logix-mobile.com/product.php?slug=product-1786616653) |
| رول ليبل باركود | 30 NIS | [صفحة المنتج](https://logix-mobile.com/product.php?slug=product-1786366489) |
| طابعة فواتير Xprinter XP-N160II | استفسر عن السعر | [صفحة المنتج](https://logix-mobile.com/product.php?slug=xprinter-xp-n160ii) |
